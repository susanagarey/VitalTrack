...
-- 
-- 
CREATE USER IF NOT EXISTS 'vitaltrackadmin'@'%' IDENTIFIED BY 'Abc123.';

GRANT ALL PRIVILEGES ON vitaltrack.* TO 'vitaltrackadmin'@'%';
FLUSH PRIVILEGES;


-- 
-- REVOKE ALL PRIVILEGES, GRANT OPTION FROM 'vitaltrackadmin'@'%';
-- FLUSH PRIVILEGES;
-- 
-- DROP USER IF EXISTS 'vitaltrackadmin'@'%';
